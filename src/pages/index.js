            ...
            <div className={styles.top}>
                <div className="text-center pt-5 md:pt-10">
                    ...
                    <div className="pt-5 md:pt-5 lg:pt-[60px]">
                        <a className="block md:inline-block hover:shadow-[0_0_2px_2px_#f14a60]  py-[12px] px-[24px] md:py-[15px] md:px-[30px] bg-[#cf394d] hover:bg-[#A83343] cursor-pointer rounded mx-2">Join Us</a>
